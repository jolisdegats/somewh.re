const Footer = () => {
  return (
    <footer className="px-6 lg:px-24 w-full bg-white dark:bg-gray-950">
      <div className="px-6 lg:px-12 py-5 flex justify-between items-center border-t border-gray-200 dark:border-gray-800">
        <div></div>
